            ...
            <el-form-item label="我的头像">
                <div class="upload-avatar" @click="openDialog">
                    ...
                    >
                        ...
                        <div>
                            <el-button @click="toImage">生成图片</el-button>
                        </div>
                    </el-dialog>
                </div>
                <!-- <div class="my-cropper"></div> -->
...
const openDialog = async () => {
    ...
    nextTick(() => {
        ...
        // console.dir(imageCropper.value.getCropperImage().$center)

        // nextTick(() => {
        //     imageCropper.value.getCropperImage().$center('contain')
        // })
    })
}
...
const toImage = () => {
    const cropperSelection = imageCropper.value.getCropperSelection()
